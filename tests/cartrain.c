...
#define test(...)        \
  ...
  test(
      ...
      "  red    train  ", true, "red", "train");
  test(
      "\\s*?(red|green|blue)?\\s*?(car|train)\\s*?",
      "red    train", true, "red", "train");
  test(
      "\\s*?(red|green|blue)?\\s*?(car|train)\\s*?",
      "  blue  car", true, "blue", "car");
  test(
      "\\s*?(red|green|blue)?\\s*?(car|train)\\s*?", "   car ",
      true, NULL, "car");
  test(
      "\\s*?(red|green|blue)?\\s*?(car|train)\\s*?", " train",
      true, NULL, "train");
  test(
      "\\s*?(red|green|blue)?\\s*?(car|train)\\s*?", "bluecar",
      true, "blue", "car");
  ...
  test(
      "\\s*?(?:(red|green|blue)\\s+?)?(car|train)\\s*?",
      "   train   ", true, NULL, "train");
  test(
      "\\s*?(?:(red|green|blue)\\s+?)?(car|train)\\s*?",
      "bluecar", false, NULL, NULL);
